...
# Modified from https://github.com/huggingface/transformers/blob/master/examples/text-classification/run_tf_text_classification.py
...
def get_tfds(
    ...
    label_list = list(set(ds[datasets.Split.TRAIN][label_name]))        
...
def main():
    ...
    if training_args.do_eval:
        ...
        print(np.argmax(trainer.predict(eval_dataset).predictions, axis=1))
        print(trainer.predict(eval_dataset).label_ids)
